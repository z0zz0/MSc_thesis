...
class ConvNet(nn.Module):
    def __init__(self):
        ...
        self.gn1 = ilm_GN(channels=5, num_groups=5)
        self.conv2 = nn.Conv3d(5, 10, 5, padding=(2, 2, 2))
        #ReLU
        #pooling
        self.gn2 = ilm_GN(channels=10, num_groups=5)

        self.conv3 = nn.Conv3d(10, 15, 3, padding=(1, 1, 1))
        self.gn3 = ilm_GN(channels=15, num_groups=5)
        self.conv4 = nn.Conv3d(15, 20, 3, padding=(1, 1, 1))
        #ReLU
        #pooling
        self.gn4 = ilm_GN(channels=20, num_groups=5)

        self.conv5 = nn.Conv3d(20, 40, 3, padding=(1, 1, 1))
        #ReLU
        #pooling
        self.gn5 = ilm_GN(channels=40, num_groups=10)

        self.conv6 = nn.Conv3d(40, 80, 3, padding=(1, 1, 1))
        #ReLU
        #pooling
        self.gn6 = ilm_GN(channels=80, num_groups=16, reduction = 8)

        self.conv7 = nn.Conv3d(80, 160, 3, padding=(1, 1, 1))
        #ReLU
        #pooling
        self.gn7 = ilm_GN(channels=160, num_groups=32, reduction = 16)

        self.conv8 = nn.Conv3d(160, 320, 3, padding=(1, 1, 1))
        #ReLU
        #pooling
        self.gn8 = ilm_GN(channels=320, num_groups=64, reduction = 32)
